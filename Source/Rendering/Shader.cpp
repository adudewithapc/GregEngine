...
void Shader::SetMatrix4x4(const std::string& name, const Mat4x4f& matrix) const
{
	glUniformMatrix4fv(glGetUniformLocation(programID, name.c_str()), 1, GL_TRUE, matrix.ToArray());
}
